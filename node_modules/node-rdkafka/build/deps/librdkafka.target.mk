...
OBJS := \
	...
	$(obj).target/$(TARGET)/deps/librdkafka/src/regexp.o \
	...
	$(obj).target/$(TARGET)/deps/librdkafka/src/rdkafka_sasl_cyrus.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/deps/librdkafka_config.stamp
...
$(builddir)/rdkafka.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/rdkafka.a: LIBS := $(LIBS)
$(builddir)/rdkafka.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/rdkafka.a: TOOLSET := $(TOOLSET)
$(builddir)/rdkafka.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)
